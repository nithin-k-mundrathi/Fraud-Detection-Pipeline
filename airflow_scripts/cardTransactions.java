// ORM class for table 'cardTransactions'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Oct 24 17:37:12 EDT 2023
...
public class cardTransactions extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("card_id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        cardTransactions.this.card_id = (Long)value;
      }
    });
    setters.put("member_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        cardTransactions.this.member_id = (Long)value;
      }
    });
    setters.put("amount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        cardTransactions.this.amount = (Integer)value;
      }
    });
    setters.put("postcode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        cardTransactions.this.postcode = (Integer)value;
      }
    });
    setters.put("pos_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        cardTransactions.this.pos_id = (Long)value;
      }
    });
    setters.put("transaction_dt", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        cardTransactions.this.transaction_dt = (String)value;
      }
    });
    setters.put("status", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        cardTransactions.this.status = (String)value;
      }
    });
  }
  ...
  public cardTransactions with_card_id(Long card_id) {
    this.card_id = card_id;
    return this;
  }
  ...
  public cardTransactions with_member_id(Long member_id) {
    this.member_id = member_id;
    return this;
  }
  ...
  public cardTransactions with_amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  public cardTransactions with_postcode(Integer postcode) {
    this.postcode = postcode;
    return this;
  }
  private Long pos_id;
  ...
  public cardTransactions with_pos_id(Long pos_id) {
    this.pos_id = pos_id;
    return this;
  }
  ...
  public cardTransactions with_transaction_dt(String transaction_dt) {
    this.transaction_dt = transaction_dt;
    return this;
  }
  ...
  public cardTransactions with_status(String status) {
    this.status = status;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof cardTransactions)) {
      return false;
    }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    cardTransactions o = (cardTransactions) super.clone();
    return o;
  }

  public void clone0(cardTransactions o) throws CloneNotSupportedException {
  }
