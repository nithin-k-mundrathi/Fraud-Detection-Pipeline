...
object sparkHiveHbaseInt2 extends App {
  ...
  conf.set("hbase.zookeeper.quorum", "m01.itversity.com,m02.itversity.com,w01.itversity.com")
...
import spark.sql
 ...
 val df_ucl = sql("""
			...
			from realtimedataproject.card_transactions
			)
			...
			from cte_rownum c
			inner join realtimedataproject.member_score_bucketed m on c.member_id=m.member_id 
			where rownum<=10
			)a
